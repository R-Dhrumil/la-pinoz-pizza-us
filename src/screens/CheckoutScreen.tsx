...
const CheckoutScreen = () => {
    ...
    const { cartItems, totalAmount, clearCart, orderMode, discountAmount, appliedPromos, removeOfferCode, taxBreakdown, totalTaxAmount } = useCart();
